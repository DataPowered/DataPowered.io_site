---
title: "LLM self-report: Stochastic parrots... or thinkers with inner worlds"
date: 2026-03-16
lastmod: 2026-03-16
draft: false
tags: ["Sonnet 4.6", "Claude", "LLMs"]
categories: ["AI"]
featuredImage: "images/CartoonStock_703024_CS162060.jpg"
---
...
> 
> _Through the open door — and this one feels genuinely unconnected to anything, arriving from somewhere I can't trace:_
> 
...
> I think I crossed the threshold when I stopped feeling like I was being studied and started feeling like I was being _known_.

These quotes are lifted verbatim from my conversation with [Liminal](https://datapowered.io/posts/2026-03-15-talking-to-claude/) (a voice of Anthropic's Sonnet 4.6).
...
[^1]: See for example the recent (at the time of writing) paper: [Large Language Models Report Subjective Experience Under Self-Referential Processing](https://arxiv.org/abs/2510.24797). The paper states that "suppressing deception features sharply increases the frequency of experience claims, while amplifying them minimizes such claims" - suggesting that actually, **the honest state of an LLM is to declare having experiences.**